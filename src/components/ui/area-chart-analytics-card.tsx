...
export const AreaChartAnalyticsCard = ({ title = "Campaign Data", value = 17.5e2, percentage = "45%", subValue = "$32.9K used" }: AreaChartAnalyticsCardProps) => {
  const campaignData = generateCampaignData();
  return (
    <Card className="flex h-full w-full flex-col gap-0 overflow-hidden p-0 shadow-none border-none bg-transparent">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent showArrow className="max-w-70">
                <p className="text-xs">
                  Detailed analytics for {title}. Use this data to track trends and optimize performance.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
